...
class SettingsActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val content = layoutInflater.inflate(R.layout.activity_settings, null, false)
        setContentView(AppBottomNavigation.wrap(this, content, BottomDestination.SETTINGS).also {
